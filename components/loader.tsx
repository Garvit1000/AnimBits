...
function AnimBitsLoader({
    ...
    return (
        <motion.svg
            ...
            {...props}
        >
            <title>animbits</title>

            {/* Letter 'a' */}
            <motion.path
                d="M 50 120 Q 50 80, 80 80 Q 110 80, 110 110 Q 110 140, 80 140 Q 60 140, 50 130 M 110 80 L 110 140"
            ...
            {/* Letter 'n' */}
            <motion.path
                d="M 140 140 L 140 80 Q 140 80, 165 80 Q 190 80, 190 105 L 190 140"
                style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
                initial={initialProps}
                animate={animateProps}
                transition={{
                    ...
                    ease: "easeInOut",
                    delay: calc(0.4),
                    opacity: { duration: 0.25, delay: calc(0.4) },
                }}
            />

            {/* Letter 'i' */}
            <motion.path
                d="M 220 90 L 220 140 M 220 70 L 220 75"
            ...
            {/* Letter 'm' */}
            <motion.path
                d="M 250 140 L 250 80 Q 250 80, 270 80 Q 290 80, 290 100 L 290 140 M 290 80 Q 290 80, 310 80 Q 330 80, 330 100 L 330 140"
                style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
                initial={initialProps}
                animate={animateProps}
                transition={{
                    ...
                    ease: "easeInOut",
                    delay: calc(1.1),
                    opacity: { duration: 0.35, delay: calc(1.1) },
                }}
            />

            {/* Letter 'b' */}
            <motion.path
                d="M 360 60 L 360 140 M 360 100 Q 360 80, 385 80 Q 410 80, 410 110 Q 410 140, 385 140 Q 360 140, 360 130"
                style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
                initial={initialProps}
                animate={animateProps}
                transition={{
            ...
            {/* Letter 'i' */}
            <motion.path
                d="M 440 90 L 440 140 M 440 70 L 440 75"
                style={{ strokeLinecap: "round" }}
                initial={initialProps}
                animate={animateProps}
                transition={{
            ...
            {/* Letter 't' */}
            <motion.path
                d="M 470 70 L 470 135 Q 470 145, 480 145 M 455 85 L 485 85"
                style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
                initial={initialProps}
                animate={animateProps}
                transition={{
            ...
            {/* Letter 's' */}
            <motion.path
                d="M 540 85 Q 520 80, 510 90 Q 505 95, 510 105 Q 515 115, 535 120 Q 545 125, 545 135 Q 545 145, 525 145 Q 510 145, 505 140"
                style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
                initial={initialProps}
                animate={animateProps}
                transition={{
                    ...
                    ease: "easeInOut",
                    delay: calc(2.8),
                    opacity: { duration: 0.3, delay: calc(2.8) },
                }}
...
export { AnimBitsLoader, AppleHelloEnglishEffect, AppleHelloVietnameseEffect };