...
<Tabs items={['CLI', 'Manual']}>
  <Tab value="CLI">
    ```bash
    npx shadcn add https://animbits.dev/r/transitions-shared-modal.json
    ```
  </Tab>
  <Tab value="Manual">
...
- **Create Actions**: "New Project", "Add Item" buttons
- **Quick Forms**: Contact forms, feedback dialogs
- **Settings Panels**: Expandable configuration menus
